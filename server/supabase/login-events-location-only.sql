...
-- Drops flattened login_events columns. Keep only location jsonb.
-- Node already reads and writes location only. Do not grant this table
-- to anon or authenticated. Do not add a user_id FK.

...
create index if not exists activity_requests_created_at_idx
  on public.activity_requests using btree (created_at desc);

create index if not exists activity_requests_request_status_idx
  on public.activity_requests using btree (request_status);

create index if not exists activity_requests_kind_idx
...
create index if not exists activity_requests_requested_by_name_idx
  on public.activity_requests using btree (requested_by_name);

create index if not exists activity_requests_pending_created_at_idx
  on public.activity_requests using btree (created_at desc)
...
drop policy if exists activity_requests_all on public.activity_requests;
drop policy if exists activity_requests_select_own on public.activity_requests;
drop policy if exists activity_requests_insert_own on public.activity_requests;
drop policy if exists activity_requests_update_own on public.activity_requests;
drop policy if exists activity_requests_delete_own on public.activity_requests;
...
-- Pending revisions of an approved transfer keep created_* ids.

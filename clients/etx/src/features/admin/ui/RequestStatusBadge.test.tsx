...
describe('RequestStatusBadge', () => {
  it('подписывает ожидающую заявку на получение как Awaiting', () => {
  ...
  it('берёт только цвета заявок для success, warning и danger и снимает скругление', () => {
  ...
  it('рисует Awaiting без capitalize у слова статуса', () => {
  ...
  it('красит cancelled квадратной приглушённой меткой', () => {

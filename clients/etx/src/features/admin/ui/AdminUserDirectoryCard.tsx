...
/**
 * Строка справочника: открыть профиль или закрепить над списком.
 *
 * Пин — отдельная кнопка, не контроль внутри ссылки. Кнопка внутри
 * ссылки не является ни ссылкой, ни кнопкой.
 */

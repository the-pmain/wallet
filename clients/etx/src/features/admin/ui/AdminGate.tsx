...
/**
 * Страж кабинета: пароль на сервере, сессия — в `localStorage`.
 *
 * Пока пароль не принят, вложенные маршруты не монтируются. После приёма
 * оболочка остаётся на месте при переходе к профилю пользователя.
 * Имя роли admin пишется только после успешного входа и не стирается
 * при блокировке.
 */

 ...
 *
 * ИСПОЛЬЗУЕТСЯ ЭТЮД METAL: тёмная плитка, фиолетовый хром, вырез
 * замочной скважины. Тот же lockup, что ETX · Metal на
 * `/logo-variants`. Исходник — `brand/icon-purple.png`.
 *

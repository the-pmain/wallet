...
beforeEach(() => {
  window.localStorage.removeItem('elmsafe.logo-study-ratings-shield')
  services = createTestAppServices()
})

describe('Shield in five materials', () => {
  it('opens gradient, crystal, and glass for ETX and Safe', async () => {
  ...
  it('remembers a rating', async () => {
    ...
    expect(window.localStorage.getItem('elmsafe.logo-study-ratings-shield')).toContain(
      '"etx-glass":4',
    )
  })
})
